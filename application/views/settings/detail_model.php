        ...
        <div class="right_col" role="main">
		  <div class="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo (!isset($data['id']) ? 'Add' : 'Edit');?> Model</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
		  			<form id="form-model" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Settings/detail_model'); ?>" method="post">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" id="model" name="model" required="required" class="form-control col-md-7 col-xs-12" value="<?php if(isset($data['model'])) echo $data['model'];?>">
                        </div>
                      </div>
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="brand" name="brand" required="required" class="form-control col-md-7 col-xs-12" value="<?php if(isset($data['brand'])) echo $data['brand'];?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="id_jenis_car" class="form-control" required="required">
							<option value="">-- Select One --</option>
							<?php
								foreach ((Array) $arrJenis as $key => $val){
									echo '<option value="'.$val['id'].'" '.((isset($data['id_jenis_car']) && $data['id_jenis_car'] == $val['id']) ? 'selected' : '').'>'.$val['jenis'].'</option>';
								}
							?>
                          </select>
                        </div>
