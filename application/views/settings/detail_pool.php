        ...
        <div class="right_col" role="main">
		  <div class="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo (!isset($data['nama']) ? 'Add' : 'Edit');?> Pool</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
		  			<form id="form-pool" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Settings/detail_pool'); ?>" method="post">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Kode Pool (3) <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
