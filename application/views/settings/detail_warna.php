        ...
        <div class="right_col" role="main">
		  <div class="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo (!isset($data['id']) ? 'Add' : 'Edit');?> Warna</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
		  			<form id="form-warna" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Settings/detail_warna'); ?>" method="post">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" id="warna" name="warna" required="required" class="form-control col-md-7 col-xs-12" value="<?php if(isset($data['warna'])) echo $data['warna'];?>">
                        </div>
                      </div>
					  <div class="form-group">
