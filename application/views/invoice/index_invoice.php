        ...
        <div class="right_col" role="main">
          <div class="row">
            ...
            <div class="x_panel tile">
                <div class="x_title">
                  <h2>Invoice <?php if($id_workshop !== '') echo '( '.get_array($arrWorkshop, $id_workshop).' - '.date('M Y', strtotime($date)).')';?></h2>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                  <form id="demo-form" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Invoice/index/'); ?>" method="post">
                	...
                	<table id="datatable" class="table table-striped" style="width:100%">
						...
						<?php
							...
							foreach ((Array) $data AS $key => $val) { 
								...
								'<td>'.($val['tipe_pembayaran'] == 1 ? 'Tunai' : ($val['tipe_pembayaran'] == 2 ? 'Tabungan' : '')).'</td>'.																
