          ...
          <div class="row">
            ...
            <div class="x_panel tile">
                ...
                <div class="x_content">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                  <form id="demo-form" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Inventory/list_stock_sparepart'); ?>" method="post">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
						  <select name="id_workshop" id="id_workshop" class="form-control" required="required">
							<?php
								...
								|| $this->user['id_privilege'] == Admin::PART_ADMIN) { //ADMINISTRATOR
					  ...
					  <a href="<?php echo base_url('/Inventory/list_history_request') ?>" class="btn btn-info" role="button">History Request</a>
				  ...
				  <div class="col-md-12 col-sm-12 col-xs-12 table-responsive" id="content_absen">
						...
						<?php
							...
							foreach ((Array) $data AS $key => $val) { 
								...
								'<td><a href="'.site_url('/Inventory/new_request/'.$val['id']).'" class="btn btn-sm btn-info" id="add_new_detail">Request</a></td>'.								
								'</tr>';
								$ct++;
							}
						?>
