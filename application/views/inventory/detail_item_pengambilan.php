...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form id="demo-form2" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Inventory/detail_pengambilan_add/'.$id_faktur); ?>" method="post">
			  ...
			  <div class="form-group" id="price_qty_div">
				...
				<div class="col-md-6 col-sm-6 col-xs-9">
				  <input type="text" id="qty" name="qty" class="form-control col-md-7 col-xs-12" required value="<?php if(isset($data['qty'])) echo $data['qty'];?>"/>
				</div>   
			  </div>
			  <div class="form-group" id="price_qty_div">
	 ...
	 $(document).ready(function() {
		$("#click_kode_barang").on("click", function(){
			...
			if($("#jenis_barang").val() == 1)
				$("#ajax-modal-barang").load('<?php echo site_url('/Inventory/get_available_sparepart');?>',
