		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel tile">
					...
					<div class="x_content">
						<a href="<?php echo base_url('/Inventory/list_history_approved') ?>" class="btn btn-info" role="button">History Approved</a>
						<div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
							<table id="datatable" class="table table-striped dataTable" style="width:100%">
								...
								?>
										<tr>
											<td><?php echo $ct;?></td>
											<td><a href="<?php echo site_url('/Inventory/detail_transfer/'.$val['id']);?>" class="blue"><?php echo $val['internal_code']; ?></td>
											<td><a href="<?php echo site_url('/Inventory/detail_transfer/'.$val['id']);?>" class="blue"><?php echo $val['kode_part']; ?></td>
