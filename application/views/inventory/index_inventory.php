			...
			<div class="col-md-12 col-sm-12 col-xs-12">
            	<div class="x_panel tile">
                	...
                	<div class="x_content">
                  			...
                  			<form id="demo-form" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Inventory/'); ?>" method="post">
					  			<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<?php
											if($this->user['id_privilege'] == Admin::ADMINISTRATOR || $this->user['id_privilege'] == Admin::PART_ADMIN 
											|| $this->user['id_privilege'] == Admin::MANAGER_AREA) { //ADMINISTRATOR
						...
						<div>
						<?php
							if($this->user['id_privilege'] == Admin::ADMINISTRATOR || $this->user['id_privilege'] == Admin::PART_ADMIN || $this->user['id_privilege'] == Admin::SCM_ADMIN ){
								echo '<div class="form-group">
										<a href="'.site_url("/Sparepart/add_master_inventory").'">
											<button type="submit" class="btn btn-primary" id="add_inventory" name="add_inventory">Tambah Master Inventory</button>
										</a>

										<a href="'.site_url("/CSoq/tambah_soq").'">
											<button type="submit" class="btn btn-primary" id="add_inventory" name="add_inventory">Tambah Data SOQ</button>
										</a>
										
										<a href="'.site_url("/CSoq/data_soq").'">
											<button type="submit" class="btn btn-primary" id="add_inventory" name="add_inventory">List Data SOQ</button>
										</a>
										
										<a href="'.site_url("/Sparepart/cari_sparepart").'">
											<button type="submit" class="btn btn-primary" id="cari_sparepart" name="cari_sparepart">Cari Sparepart</button>
										</a>
							  	</div>';
...
<!--     <script>
      $(document).ready(function() {
		$('#datatable').dataTable( {buttons:['excel','csv']} );
	  });
    </script> -->
