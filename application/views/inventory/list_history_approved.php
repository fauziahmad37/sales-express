		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel tile">
					...
					<div class="x_content">
						<!-- <button class="btn btn-success">History Approved</button> -->
						<div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
							<table id="datatable" class="table table-striped dataTable" style="width:100%">
								...
								?>
										<tr>
											<td><?php echo $ct;?></td>
											<td><a href="<?php echo site_url('/Inventory/detail_transfer/'.$val['id']);?>" class="blue"><?php echo $val['internal_code'] ;?></a></td>
