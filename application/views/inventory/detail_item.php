...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form id="demo-form2" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Inventory/detail_add/'.$id_faktur); ?>" method="post">
			  ...
			  <div class="form-group" id="price_qty_div">
				...
				<div class="col-md-6 col-sm-6 col-xs-9">
				  <input type="number" id="qty" name="qty" class="form-control col-md-7 col-xs-12" min="1" required value="<?php if(isset($data['qty'])) echo $data['qty'];?>"/>
				</div>   
			  </div>
			  <div class="form-group" id="price_qty_div">
				...
				<div class="col-md-6 col-sm-6 col-xs-9">
				  <input type="number" id="harga_satuan" name="harga_satuan" class="form-control col-md-7 col-xs-12" min="1" required value="<?php if(isset($data['harga_satuan'])) echo $data['harga_satuan'];?>"/>
				</div>   
			  </div>
			  <div class="form-group" id="price_qty_div">
				...
				<div class="col-md-6 col-sm-6 col-xs-9">
				  <input type="number" id="diskon" name="diskon" class="form-control col-md-7 col-xs-12" min="0" max="100" required value="<?php if(isset($data['diskon'])) echo $data['diskon'];?>"/>
				</div>   
			  </div>
			  
			  <div class="form-group" id="price_qty_div">
				<label class="control-label col-md-3 col-sm-3 col-xs-12" for="ppn">PPN (%) <span class="required">*</span>
				</label>
				<div class="col-md-6 col-sm-6 col-xs-9">
				  <input type="number" id="ppn" name="ppn" class="form-control col-md-7 col-xs-12" min="0" max="100" required value="<?php if(isset($data['ppn'])) echo $data['ppn'];?>"/>
				</div>   
			  </div>
			  <div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12" for="loc_part">Lokasi Part <span class="required">*</span>
				</label>
				<div class="col-md-6 col-sm-6 col-xs-9">
				  <input type="text" id="loc_part" name="loc_part" class="form-control col-md-7 col-xs-12" required value="<?php if(isset($data['loc_part'])) echo $data['loc_part'];?>"/>
				</div>   
			  </div>			  			  			  
	 ...
	 $(document).ready(function() {
		$("#click_kode_barang").on("click", function(){
			...
			if($("#jenis_barang").val() == 1)
				$("#ajax-modal-barang").load('<?php echo site_url('/Inventory/get_sparepart');?>',
				{"id_faktur": <?php echo $id_faktur;?>, "id_workshop": <?php echo $id_workshop;?>});
			else if($("#jenis_barang").val() == 2)
				$("#ajax-modal-barang").load('<?php echo site_url('/Inventory/get_material');?>',
				{"id_faktur": <?php echo $id_faktur;?>, "id_workshop": <?php echo $id_workshop;?>});
		});
