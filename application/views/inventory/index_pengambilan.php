        ...
        <div class="right_col" role="main">
          <div class="row">
            ...
            <div class="x_panel tile">
                <div class="x_title">
                  <h2>Data Supply Slip <?php if($id_workshop !== '') echo '( '.array_get($arrWorkshop, $id_workshop, 'id', 'name').' - '.date('M Y', strtotime($date)).')';?></h2>                 
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                  <form id="demo-form" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Inventory/pengambilan/'); ?>" method="post">
				  ...
				  <div class="col-md-12 col-sm-12 col-xs-12 table-responsive" id="content_absen">
                                       <a href="<?php echo site_url('Inventory/pengambilan_add');?>" class="btn btn-dark">Buat Supply Slip Baru</a>
                                       <p>
				  		<table id="datatable" class="table table-striped dataTable text-center" style="width:100%">
						<thead>
							<tr>
								<th class="text-center">Tanggal</th>
								<th class="text-center">Nomor Supply Slip</th>
								<th class="text-center">Nomor Work Order</th>
								<th class="text-center">Pembuat Supply Slip</th>																
								<th class="text-center">Status Supply Slip</th>
						...
						<?php
							...
							foreach ((Array) $data AS $key => $val) { 
								echo '<tr><td>'.($val['updated_dt'] == null ? date('d M Y', strtotime($val['created_dt'])) : date('d M Y', strtotime($val['updated_dt']))).'</td>'.          
								...
								'<td><a href="'.site_url('/Inventory/detail_pengambilan_add/'.$val['id']).'" class="btn btn-sm btn-info">Detil</a></td>'.
								'</tr>';
								$ct++;
							}
						?>
