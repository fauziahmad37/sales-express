        ...
        <div class="right_col" role="main">
          <div class="row">
            ...
            <div class="x_panel tile">
                <div class="x_title">
                  <h2>Work Order <?php if($id_workshop !== '') echo '( '.get_array($arrWorkshop, $id_workshop).' - '.date('M Y', strtotime($date)).')';?></h2>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                  <form id="demo-form" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Work_order/index/'); ?>" method="post">
                ...
                <div class="x_content table-responsive">
					...
					if(
						...
						echo '<a href="'.site_url('/Work_order/new_wo').'"><button class="btn btn-info">Buat WO Baru</button></a>';
					}
					?>
                </div>
              </div>
