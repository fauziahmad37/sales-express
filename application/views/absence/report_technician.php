          	...
          	<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
                	...
                	<div class="x_title">
                		...
                		<?php
                			if ($id_workshop !== '') {
                				echo '('.get_array($arrWorkshop, $id_workshop).' - ' .date('M Y', strtotime($date)).')';
                			}
                		?>
                		</h2>
                	...
                	<div class="x_content">
                  		<div class="col-md-12 col-sm-12 col-xs-12">
                  			<form id="demo-form" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/report_technician/index/'); ?>" method="post">
					...
					if(is_same_month && k.toString() === today_dt){
						...
						<?php
							foreach ($dataReport as $key => $val) {
								# code...
						?>
						div += '<td><?php echo $val['jumlah_kerja']; ?>';
						<?php
							}
						?>
					}
