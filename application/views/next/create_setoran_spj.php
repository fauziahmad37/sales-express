        ...
        <div class="right_col" role="main">
		  <div class="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Create Setoran SPJ </h2>
                    <div class="clearfix"></div>
                  </div>
				  <div id="ajax-modal-savings" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true" style="display: none;"></div>                  
                  <div class="x_content">
		  			<form id="demo-form2" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Spj/save_setoran_spj'); ?>" onsubmit="return cekTagihan()" method="post">
 ...
 <div class="ln_solid"></div>
					...
					<div class="form-group" id="div_no_pintu">
					  ...
					  <div class="form-group" id="div_no_pintu">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="jam_cetak_spj">Jam Checker Check<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
					  ...
					  <div class="form-group" id="div_no_pintu">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="jam_cetak_spj">Jam Mulai Denda<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
					   ...
					   <div class="form-group" id="div_no_pintu">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="setoran_wajib">Setoran Wajib<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
						 
						<input type="text" id="setoran_wajib" value ="0" name="setoran_wajib" class="form-control col-md-7 col-xs-12" required="required" readonly/>
						</div>
					  ...
					  <div class="form-group" id="div_no_pintu">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="denda">Cicilan Seragam<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
					  ...
					  <div class="form-group" id="div_no_pintu">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="total_tagihan">Total Tagihan<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
					   ...
					   <div class="form-group" id="div_no_pintu">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="payment_cash">Payment Cash<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
						 
						<input type="text" onchange="getKembalian()" id="payment_cash"  name="payment_cash" value ="0" class="form-control col-md-7 col-xs-12" required="required" />
						</div>
					   ...
					   <div class="form-group" id="div_no_pintu">
						...
						<div class="col-md-6 col-sm-6 col-xs-9">
						<input type="text" onchange="getKembalian()" id="amount_credit_ticket"  name="amount_credit_ticket" value ="0" class="form-control col-md-7 col-xs-12" />
					   ...
					   <div class="form-group" id="div_no_pintu">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="total_tagihan">Kembalian<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
...
<script src="<?php echo base_url('/assets/js/bootstrap-datetimepicker.min.js');?>"></script>
 ...
 $(document).ready(function(){
		 ...
		 $( "#spj_number" ).autocomplete({
              source: "<?php echo site_url('Spj/get_autocomplete_payment_spj');?>",
	...
	var total = cash+credit_ticket+jamin;
...
function getKembalian() {
	...
	if((jamin+cash+credit_ticket) > total_tagihan)
	 {
	  if (((cash+credit_ticket) - total_tagihan)>=0)
	  {
		  kembalian.value =(cash+credit_ticket) - total_tagihan;
	  }
