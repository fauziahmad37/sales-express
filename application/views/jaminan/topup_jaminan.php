		  ...
		  <div class="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
		  			<form id="demo-form2" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Jaminan/save_topup_jaminan'); ?>" method="post">
					  ...
					  <div class="form-group" id="ketentuan_jaminan">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Ketentuan Jaminan<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
					  ...
					  <div class="form-group" id="tipe">
						...
						<div class="col-md-6 col-sm-6 col-xs-9">
						<input type="text" id="tipe" name="tipe" class="form-control col-md-7 col-xs-12" required="required" readonly/>
						</div>                  
					  </div>
					  
					<div class="form-group" >
						<label class="control-label col-md-3 col-sm-3 col-xs-12">Hari Kerja <span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
					  ...
					  <div class="form-group" >
						<label class="control-label col-md-3 col-sm-3 col-xs-12">Limit HK Cicilan Jaminan <span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
						<input type="text" id="limit_hk_cicilan_jaminan" name="limit_hk_cicilan_jaminan" class="form-control col-md-7 col-xs-12" required="required" readonly/>
						</div>                  
					  </div>
					  
					  
					  <div class="form-group" >
						<label class="control-label col-md-3 col-sm-3 col-xs-12">Cicilan Jaminan <span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
						<input type="text" id="has_cicilan_jaminan" name="has_cicilan_jaminan" class="form-control col-md-7 col-xs-12" required="required" readonly/>
						</div>                  
					  </div>
					  ...
					  <div class="form-group" id="div_no_pintu">
					   ...
					   <div class="form-group" id="div_no_pintu">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Penambahan Jaminan<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
...
$(document).ready(function(){
	...
	$( "#kip_number" ).autocomplete({
		...
		select: function( event, ui ) { 
			...
			$('[name="limit_hk_cicilan_jaminan"]').val(ui.item.limit_hk_cicilan_jaminan);
			$('[name="has_cicilan_jaminan"]').val(ui.item.has_cicilan_jaminan);
