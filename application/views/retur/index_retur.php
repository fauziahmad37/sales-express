		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel title">
				...
				<div class="x_content table-responsive">
					<a href="<?php echo site_url('Retur/retur_add') ?>" class="btn btn-dark">Buat Retur Baru</a>
					<table id="dataTable" class="table table-striped dataTable text-center" style="width: 100%">
						...
						<?php  
							...
							foreach ((Array)$data as $key => $val) {
								echo '<tr>
									<td>'.$no.'</td>
									<td><a href="'.site_url('/Retur/detail_retur_add/').$val['id'].'" class="blue"> '.$val['retur_number'].'</a></td>
									<td>'.$val['wo_number'].'</td>
									<td>'.$val['no_pintu'].'</td>
									<td>'.$val['no_polisi'].'</td>
									<td>'.$val['nama'].'</td>
									<td>'.$val['retur_note'].'</td>				
								</tr>';
								$no++;
							}
						?>
