        ...
        <div class="right_col" role="main">
          <div class="row">
            ...
            <div class="x_panel tile">
                <div class="x_title">
                  <h2>List of Setoran SPJ Tiara</h2>
                  <div class="clearfix"></div>
                </div>
				
				<form id="demo-form" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Spj/index_setoran_tiara/'); ?>" method="post">
                	...
                	<table id="datatable" class="table table-striped" style="width:100%">
						<thead>
							<tr>
								...
								<th>Amt Cash</th>
								<th>Amt Jaminan</th>
								<th>Amt Credit Ticket</th>
								<th>Amt Charge Room</th>
								<th>Amt EDC</th>
								<th>Kembalian</th>
								<th>SPJ Date</th>
								<th>Penalty Date</th>
						...
						<?php
							...
							foreach ((Array) $data AS $key => $val) { 
								...
								'<td>'.number_format($val['payment_via_charge_room']).'</td>'.
								'<td>'.number_format($val['payment_via_edc']).'</td>'.
				...
				<div class="">
						  ...
						  <a href="<?php echo base_url().'Spj/create_setoran_spj_tiara/'; ?>"><button type="submit" class="btn btn-success" id="save" name="save">Add New Setoran SPJ Tiara</button></a>
