				...
				<div class="x_content">
					<form id="demo-form2" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Spj/save_setoran_spj'); ?>" onsubmit="return cekTagihan()" method="post">
						<div class="form-group">
							...
							<input type="hidden" id="has_cicilan_jaminan" name="has_cicilan_jaminan" />
							...
							<div class="form-group" id="div_no_pintu">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="denda">Cicilan Jaminan<span class="required">*</span></label>
								<div class="col-md-6 col-sm-6 col-xs-9">
							...
							<div class="form-group" id="div_no_pintu">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="kembalian">Kembalian<span class="required">*</span></label>
								<div class="col-md-6 col-sm-6 col-xs-9">
...
$(document).ready(function(){
	...
	$( "#spj_number" ).autocomplete({
		...
		select: function( event, ui ) { 
			...
			if( hari_kerja < limit_hk_cicilan_jaminan+1 && jaminan < 500000 ){
