	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<form id="demo-form2" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Spj/save_spj'); ?>" method="post">
						<div class="form-group">
							<input type="hidden" id="id_car" name="id_car"/>
							<input type="hidden" id="driver_id" name="driver_id"/>
							<input type="hidden" id="created_dt" name="created_dt"/>
							<input type="hidden" id="cetak_spj" name="cetak_spj"/>
							...
							<div class="form-group" id="tipe_driver">
							...
							<div class="form-group" id="hari_kerja">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Hari Kerja <span class="required">*</span></label>
								<div class="col-md-6 col-sm-6 col-xs-9">
							...
							<div class="form-group" id="ketentuan_jaminan">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Ketentuan Jaminan Driver<span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-9">
...
<script type="text/javascript">	
	...
	$(document).ready(function(){
		...
		var v_tipe_rental = "24 Jam";
		
		$( "#kip_number" ).autocomplete({
			source: "<?php echo site_url('Spj/get_autocomplete');?>",
			select: function(event, ui){ 
				...
				$('[name="tipe_driver"]').val(ui.item.tipe_driver);
				$('[name="hari_kerja"]').val(ui.item.hari_kerja);
				$('[name="cetak_spj"]').val(ui.item.cetak_spj);
		...
		$( "#door_number" ).autocomplete({
			source: "<?php echo site_url('Spj/get_autocomplete_door_number');?>",
			select: function( event, ui ) { 
				event.preventDefault();
