        ...
        <div class="right_col" role="main">
          <div class="row">
            ...
            <div class="x_panel tile">
                <div class="x_title">
                  <h2>List of SPJ Regular (Surat Perintah Jalan)</h2>
                  <div class="clearfix"></div>
                </div>
				
				<form id="demo-form" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Spj/index/'); ?>" method="post">
				...
				<div class="">
					...
					?>
					<a href="<?php echo base_url().'Spj/create_spj/'; ?>"><button type="submit" class="btn btn-success" id="save" name="save">Add New SPJ (Surat Perintah Jalan)</button></a>
				</div>
