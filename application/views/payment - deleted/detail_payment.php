		  ...
		  <div class="row">
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" id="print_area">
                  <div class="x_title">
                    <h4>Detail Pembayaran Tagihan #<?php echo $data['invoice_number'];?></h4>
                  ...
                  <div class="x_content" >
					<div class="card col-md-10 col-sm-12 col-xs-12"> 							
						<table class="table borderless" style="width:100%">
							<tr>
								<td style="padding:0px !important" width="130px"><small>Nama Pelanggan</small></td>
							...
							<tr>
								<td style="padding: 0px !important"><small>Tabungan Awal</small></td>
								<td style="padding: 0px !important"><small>:</small></td>
								<td style="padding: 0px !important"><small>Rp. <?php echo number_format($data['tab_awal']) ?></small></td>
								<td style="padding: 0px !important"></td>
							</tr>
							<tr>
								<td style="padding:0px !important"><small>Jenis Pembayaran</small></td>
								<td style="padding:0px !important"><small>:</small></td>
								<td style="padding:0px !important"><small><?php echo $data['jenis_pembayaran']; //echo ($data['tipe_pembayaran'] == 1 ? 'Tunai' : $data['tipe_pembayaran']== 2 ? 'tabungan' : $data['tipe_pembayaran']== 3 ? 'OHL' : 'lain-lain') ; ?></small></td>
								<td style="padding:0px !important"></td>								
							</tr>
						...
						<span class="left col-md-6 text-center">
							...
							<br/><small><strong><?php echo array_get($users, $data['receiver_id'], 'id', 'full_name'); ?></strong></small>
						</span>
						<span class="col-md-6 text-center" style="float:right">
							<br/><small>Diterima oleh:</small><br/><br/><br/>
							<br/><small><strong><?php echo $data['nama_customer'] ?></strong></small>
						</span>
					</div>
				  </div>  
						...
						<div class="col-xs-12">
							...
							if($this->user['id_privilege'] == Admin::ADMINISTRATOR
								|| $this->user['id_privilege'] == Admin::CASHIER)
								 ?><a class="btn btn-info pull-center"  href="<?php echo site_url('/Payment/print_detail_invoice/'.$data['id_invoice']);?>" target="_blank"  role = "button">Cetak Detail Pembayaran</a>   	<?php	
							?>
						</div>
					</div>
            	</div>
