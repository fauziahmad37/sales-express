		  	...
		  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="tipe_pembayaran_wo">Tipe Pembayaran WO
						</label>
						<div class="col-md-6 col-sm-6 col-xs-9">
							<input type="text" id="tipe_pembayaran_wo" name="tipe_pembayaran_wo" class="form-control col-md-7 col-xs-12" readonly/>
						</div>                   
					</div>
...
<input type="hidden" id="loc_tab" name="loc_tab">
    ...
    <script>
      $(document).ready(function() {
		...
		$('#click_tabungan').on("click", function(){
			...
			if((pool == 'POOL PONDOK BAMBU')||(pool == 'POOL PEKAPURAN') || (pool == 'POOL C - JAGAKARSA') || (pool == 'POOL CIPAYUNG') || (pool == 'POOL CIPENDAWA') || (pool == 'POOL A - BINTARO')){
				
				$.ajax({
					url: "<?php echo site_url('/Payment/etaxi_show_tab/');?>",
						type: "POST",
