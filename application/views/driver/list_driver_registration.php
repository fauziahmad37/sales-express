        ...
        <div class="right_col" role="main">
          <div class="row">
            ...
            <div class="x_panel tile">
                ...
                <div class="x_content">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                  <form id="demo-form" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Driver/list_driver_registration/'); ?>" method="post">
                	...
                	<table id="datatable" class="table table-striped" style="width:100%">
						...
						<?php
							...
							?>	<tr>
								...
								<td>
									<a href="<?php echo site_url('/Driver/view_detail_registration_driver/'.$val['id']); ?>" class="blue"><?php echo $val['ktp_number']; ?></a>
								</td>
								<td><?php echo '-'; ?></td>
								<td><?php echo $val['name']; ?></td>
								<td><?php echo $val['created_dt']; ?></td>
								<td><?php echo 'Driver - '.$val['ketentuan_jaminan']; ?></td>								
