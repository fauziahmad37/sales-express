	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel tile">
				<div class="x_title">
					<h2>Pemotongan Tabungan Simtax <?php if($id_workshop !== '') echo '( '.get_array($arrWorkshop, $id_workshop).' - '.date('M Y', strtotime($date)).')';?></h2>
					<div class="clearfix"></div>
                </div>
				<div class="x_content">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<form id="demo-form" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('/Akunting/transaksi_pemotongan_tabungan/'); ?>" method="post">
								...
								<?php
									...
									foreach((Array) $data as $key => $var){
										...
										'<tr>
											...
											<td>'.$var['NO_PINTU'].'</td>
											<td>'.$var['KIP_SETOR'].'</td>
											<td>Rp '.number_format($var['NILAI_TAB']*-1).'</td>
